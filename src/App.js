        ...
        <div className="container h-100">
          <div className="row h-100 align-items-center justify-content-center text-center">
            ...
            <div className="col-lg-8 align-self-baseline">
              <p className="text-white-75 font-weight-light mb-5">Start Bootstrap can help you build better websites using the
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center">
              ...
              <p className="text-white-50 mb-4">Start Bootstrap has everything you need to get your new website up and running
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                ...
                <hr className="divider my-4" />
                <p className="text-muted mb-5">Ready to start your next project with us? Give us a call or send us an email and we
